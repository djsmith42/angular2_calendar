  ...
  function main() {
    ...
    describe("parser", (function() {
      describe("parseAction", (function() {
        ...
        it("should error when using pipes", (function() {
      ...
      describe("parseBinding", (function() {
        describe("pipes", (function() {
          ...
          it("should parse pipes with args", (function() {
      ...
      describe('addPipes', (function() {
        it('should return the given ast whe the list of pipes is empty', (function() {
          var ast = parseBinding("1 + 1", "Location");
          var transformedAst = addPipes(ast, []);
          expect(transformedAst).toBe(ast);
        }));
        it('should append pipe ast nodes', (function() {
          var ast = parseBinding("1 + 1", "Location");
        ...
        it('should preserve location and source', (function() {
          var ast = parseBinding("1 + 1", "Location");
          var transformedAst = addPipes(ast, ['one', 'two']);
