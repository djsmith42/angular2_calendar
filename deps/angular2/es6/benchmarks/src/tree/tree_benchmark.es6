...
import {DOM,
  ...
  window,
  Element,
  gc} from 'angular2/src/facade/dom';
...
function setupReflector() {
  ...
  reflector.registerType(Compiler, {
    'factory': (cd, templateLoader, reader, parser, compilerCache, strategy, resolver) => new Compiler(cd, templateLoader, reader, parser, compilerCache, strategy, resolver),
...
var BASELINE_TREE_TEMPLATE = DOM.createTemplate('<span>_<template class="ng-binding"></template><template class="ng-binding"></template></span>');
var BASELINE_IF_TEMPLATE = DOM.createTemplate('<span template="if"><tree></tree></span>');
...
//# sourceMappingURL=/Users/patrick/Documents/open source/angular/modules/benchmarks/src/tree/tree_benchmark.map
