...
import {Parser,
  Lexer,
  ChangeDetector,
  ChangeDetection} from 'angular2/change_detection';
...
import {App,
  setupReflectorForApp} from './app';
import {ScrollAreaComponent,
  setupReflectorForScrollArea} from './scroll_area';
import {ScrollItemComponent,
  setupReflectorForScrollItem} from './scroll_item';
import {CompanyNameComponent,
  OpportunityNameComponent,
  OfferingNameComponent,
  AccountCellComponent,
  StageButtonsComponent,
  FormattedCellComponent,
  setupReflectorForCells} from './cells';
...
export function setupReflectorForAngular() {
  ...
  reflector.registerType(Compiler, {
    "factory": (changeDetection, templateLoader, reader, parser, compilerCache, shadowDomStrategy, resolver) => new Compiler(changeDetection, templateLoader, reader, parser, compilerCache, shadowDomStrategy, resolver),
...
//# sourceMappingURL=/Users/patrick/Documents/open source/angular/modules/benchmarks/src/naive_infinite_scroll/index.map
