...
export class Runner {
  ...
  sample({id,
    ...
    return assert.returnType((new Injector(sampleBindings).asyncGet(Sampler).then((sampler) => sampler.sample())), assert.genericType(Promise, SampleState));
  }
}
...
//# sourceMappingURL=/Users/patrick/Documents/open source/angular/modules/benchpress/src/runner.map
