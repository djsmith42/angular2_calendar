    ...
    describe('readPerfLog', () => {
      ...
      if (isJsObject({})) {
        it('should throw an error on buffer overflow', (done) => {
          createExtension([chromeTimelineEvents.start('FunctionCall', 1234)], 'Tracing.bufferUsage').readPerfLog().then(null, (err) => {
            expect(() => {
              throw err;
...
//# sourceMappingURL=/Users/patrick/Documents/open source/angular/modules/benchpress/test/webdriver/chrome_driver_extension_spec.map
