...
import {WebDriverExtension,
  ...
  WebDriverAdapter,
  Injector,
  bind} from 'benchpress/benchpress';
  ...
  describe('ios driver extension', () => {
    ...
    describe('readPerfLog', () => {
      ...
      it('should report gc', (done) => {
        createExtension([gcRecord(1, 3, 21)]).readPerfLog().then((events) => {
      ...
      it('should walk children', (done) => {
        createExtension([durationRecord('FunctionCall', 1, 5, [timeBeginRecord('someName', 2)])]).readPerfLog().then((events) => {
...
//# sourceMappingURL=/Users/patrick/Documents/open source/angular/modules/benchpress/test/webdriver/ios_driver_extension_spec.map
